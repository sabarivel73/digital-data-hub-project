        ...
        <div class="container">
          <div class="center">
            <?php
                ...
                {
                    $sql="INSERT INTO comment(UID, COMM, LOGS) VALUES ({$_SESSION["ID"]},'{$_POST["mes"]}',now())";
                    $db->query($sql);
            ...
            <form action="<?php echo $_SERVER["REQUEST_URI"];?>"method="post">
                ...
                <a href="dlhome.php">Home</a>
            </form>
            <p><span>NOTE</span> : Mention the topics before send your comments like Eligiblity Check,Demo Form for DL and Required Documents for DL.</p>
          </div>
          <div class="footer">
