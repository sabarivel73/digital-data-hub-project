        ...
        <div class="container">
          <div class="center">
            <?php
                ...
                {
                    $sql="INSERT INTO comment4(UID, COMM, LOGS) VALUES ({$_SESSION["ID"]},'{$_POST["mes"]}',now())";
                    $db->query($sql);
            ...
            <form action="<?php echo $_SERVER["REQUEST_URI"];?>"method="post">
                ...
                <a href="commentbl1.php">Refresh</a>
                <a href="basiclaw.php">Home</a>
            </form>
            <p><span>NOTE</span> : Mention the topics before send your comments.</p>
          </div>
          <div class="footer">
