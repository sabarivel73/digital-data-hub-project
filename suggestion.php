        ...
        <div class="container">
            <div class="center">
                <?php
                    ...
                    {
                        $sql="insert into suggestion (UID,MES,LOGS) values ({$_SESSION["ID"]},'{$_POST["mess"]}',now() )";
                        $db->query($sql);
                        echo "<p class='success'>Suggestion Sent</p>";
                    }   
                ?>
                <form action="<?php echo $_SERVER["PHP_SELF"];?>" method="post">
                    <h3 class="heading">Give Your Suggestion</h3>
                    <label>Message</label>
                    <input required name="mess"></input>
                    <button type="submit" name="submit">Send</button>
                    <a href="view_seg.php">View Your Suggestion</a>
                    <a href="mhome.php">Home</a>
                    <a href="suggestion.php">Refresh</a>
                </form>
            </div> 
            <div class="footer">
