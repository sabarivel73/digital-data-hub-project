        ...
        <div class="container">
          <div class="center">
            <?php
                ...
                {
                    $sql="INSERT INTO comment3(UID, COMM, LOGS) VALUES ({$_SESSION["ID"]},'{$_POST["mes"]}',now())";
                    $db->query($sql);
            ...
            <form action="<?php echo $_SERVER["REQUEST_URI"];?>"method="post">
                ...
                <a href="commentrs1.php">Refresh</a>
                <a href="rs.php">Back</a>
            </form>
            <p><span>NOTE</span> : Mention the topics before send your comments like Road Safety Rules & Regulations.</p>
          </div>
          <div class="footer">
