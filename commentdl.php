...
<html>
    ...
    <body>
        <div class="container">
            <h1>View user comments about DL</h1>
            <nav>
                <ul>
          ...
          <div class="main">
           <div class="content">
            <?php
                $sql="SELECT user.UNAME,comment.COMM,comment.LOGS FROM comment INNER JOIN user on comment.UID=user.UID ORDER BY comment.CID DESC";
                $res=$db->query($sql);
                if($res->num_rows>0)
                {
