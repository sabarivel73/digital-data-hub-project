...
<html>
    ...
    <body>
       <div class="container">
            <div class="row">
              <h2>This are basic laws based on Indian Government and more laws are present in our government.</h2>
            </div>
            <div class="navbar">
                <nav>
                    <ul>
        ...
        <div class="main">
            <div class="content">
                        ...
                        <h3>Some of the important sections in the Motor Vehicles Act 1988</h3>
                        <ul>
                        ...
                        <h3>In India, abusive behavior can be addressd under various laws depending on the abuse.Here are some sections from Indian laws that deal with abusive behavior.</h3>
                        <ul>
                        ...
                        <h3>Some of the important sections in the Right to Education Act 2009,The Child Labour (Prohibition and Regulation) Act 1986 and The Dowry Prohibition Act 1961.</h3>
                        <ul>
                        ...
                        <h3>Some of the important sections in the Companies Act 2013,Income Tax Act 1961,Goods and Services Tax(GST) Act,Labour Laws and Environmental Laws.</h3>
                        <ul>
                        ...
                        <h3>Some of the important sections in the Police Act 1861,Motor Vehicles Act 1988 and Indian Penal Code 166A.</h3>
                        <ul>
                        ...
                        <h3>Some of the important sections in the Hotels and Restaurant Act 1956,The Food Safety and Standards Act 2006 and The Foreigners Act 1946.</h3>
                        <ul>
                        ...
                        <h3>Some of the important sections in the Part 2:Citizenship(Articles 5-11) and Part 3:Citizenship(Articles 12-35).</h3>
                        <ul>
