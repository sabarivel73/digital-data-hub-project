...
<html>
    ...
    <body>
       <div class="container">
          <h1>Demo Form for DL</h1>
            <nav>
                    <ul>
                        <button><a href="comment.php">Send your comments</a></button>
                        <button><a href="demodl.php">Refresh</a></button>
                        <button><a href="dlhome.php">Back</a></button>
                    </ul>
            </nav>
        </div>
        <div class="main">
         <div class="content">
          <form action="sbdl.php" method="post">
              <h3>Basic details are automatically fetch from your LLR like Name,Father Name,State,Date of Birth etc...,</h3>
              <span>In this demo from we give some field not all and you have to practice before move to original form.</span><br><br>
              <span>NOTE</span> : This data already display based on your LLR you can check it once but you cann't see then you fill this.
              <br><br>
                <label><b>Place of Birth</b> :</label>
                <input name="pob" type="text" required><br><br>
                ...
                <input type="text" name="mra" required><br><br>
                ...
                <input type="text" name="bg" required><br><br>
                ...
                <span>NOTE : if you select [MCWG] you need not to select [MCWOG] and this is important to select because if you select both MCWG and LMV then you can drive both on same date.</span>
                <br><br>
