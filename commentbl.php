...
<html>
    ...
    <body>
        <div class="container">
            <h1>View user comments about Basic Laws to known</h1>
            <nav>
                <ul>
          ...
          <div class="main">
           <div class="content">
            <?php
                $sql="SELECT user.UNAME,comment4.COMM,comment4.LOGS FROM comment4 INNER JOIN user on comment4.UID=user.UID ORDER BY comment4.CID DESC";
                $res=$db->query($sql);
                if($res->num_rows>0)
                {
