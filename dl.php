...
<html>
    ...
    <body>
       <div class="container">
          <div class="wrapper">
              <h1 class="heading">Welcome to DL Information based on Indian Government</h1>
          </div>
       </div>
       <div class="main">
           <div class="content">
                <h2>Hi <?php echo $_SESSION["NAME"]; ?> would you select your state</h2>
                    <form action="dlhome.php" method="post" >
                        ...
                        <button type="submit" name="submit" onclick="dlstate()"><a href="dlhome.php">Go</a></button><br>
                        <a href="dl.php">Refresh</a><br><br>
